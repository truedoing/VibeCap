...
4.5 ★★ 亲属称谓解析铁律 ★★
   对话里的亲属称谓必须解析成正式名后才能列入 characters，解析出的人如果确实在这场戏，绝不能漏：
     大哥/老大 → 苏明哲 | 二哥/明成 → 苏明成 | 小妹 → 苏明玉
     爸/爸爸/老爷子（明玉/明成/明哲喊的）→ 苏大强 | 丽丽 → 朱丽
     哥（明玉喊）= 苏明成 | 大哥（明成/明玉喊）= 苏明哲
   （例：字幕"你放心大哥"→ 明成对明哲说 → 苏明哲在这场，必须列入 characters）
