...
★ 怎么排（解说/原声交替）:
  解说是主线（论证），原声是武器（举证/引爆/钉人/锚定）。交替推进，不是解说里夹台词。
  · 解说段：narration_text 非空
  · 原声段：highlight_text 填名场面里的代表台词（从喂给你的 ASR 里逐字选），让观众"听到原剧"
  节奏：原声约占 1/3，连续纯解说最多 3 段。开头用原声引爆，结尾纯解说收束。
