...
DB_PATH = Path(__file__).resolve().parent.parent / "vibecut.db"
...
_parser = _argparse.ArgumentParser(description="VibeCut 后端服务")
_parser.add_argument("--project", default=os.environ.get("VibeCut_PROJECT", ""), help="项目名")
_parser.add_argument("--drama", default=os.environ.get("VibeCut_DRAMA", ""), help="电视剧名 (兼容旧参数)")
_parser.add_argument("--task", default=os.environ.get("VibeCut_TASK", "Task7024"), help="任务名")
...
class Handler(SimpleHTTPRequestHandler):
    ...
    def _create_task(self):
        ...
        try:
            ...
            env = {**__import__("os").environ, "VibeCut_DRAMA": drama_name, "VibeCut_TASK": task_name}
...
if __name__ == "__main__":
    port = _args.port
    print(f"VibeCut 后端: project={_project_name} (type={_project_type})  task={_args.task}")
