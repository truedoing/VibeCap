...
# ── 注册所有 Router ──
from routers import search, task_crud, segments, media, ai, sse_script, sse_voiceover, pipeline, export, picks, topics, static
...
app.include_router(topics.router)              # /topics 选题推荐
