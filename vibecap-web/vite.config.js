...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/dialogue_match': 'http://localhost:8766',
      '/dramas': 'http://localhost:8766',
      '/tasks': 'http://localhost:8766',
      '/tasks/create': 'http://localhost:8766',
      '/posters': 'http://localhost:8766',
      '/data': 'http://localhost:8766',
      '/picks': 'http://localhost:8766',
      '/proxies': 'http://localhost:8766',
      '/export': 'http://localhost:8766',
      '/export_clips': 'http://localhost:8766',
    }
  }
})
